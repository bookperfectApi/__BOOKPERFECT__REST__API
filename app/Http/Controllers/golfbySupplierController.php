 ...
 *   tags={"@Contracts"},
 *   summary="GET GOLF BY SUPPLIERID",
 *   operationId="1",
 *
 *  @OA\Parameter(
 *      name="supplierid",
...
class golfbySupplierController extends Controller
{
    public function index($supplierid)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://bookperfect.paquetedinamico.com/resources/golf/".$supplierid,
