 ...
 *   tags={"@Contracts"},
 *   summary="GET TICKET BY SUPPLIERID",
 *   operationId="6",
 *  @OA\Parameter(
 *      name="supplierid",
 *      in="path",
 ...
 *)
 **/
class ticketSupplieridController extends Controller
{
    ...
    public function index($supplierid)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://bookperfect.paquetedinamico.com/resources/ticket/" . $supplierid,
