 ...
 *   tags={"@Contracts"},
 *   summary="GET TRANSPORT BY SUPPLIERID",
 *   operationId="10",
 *  @OA\Parameter(
 *      name="supplierid",
 *      in="path",
 ...
 *)
 **/
class transport_supplieridController extends Controller
{
    ...
    public function index($supplierid)
    {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://bookperfect.paquetedinamico.com/resources/transport/".$supplierid,
