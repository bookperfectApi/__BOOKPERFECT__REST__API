 ...
 *   tags={"@Contracts"},
 *   summary="GET TRANSFER BY SUPPLIERID",
 *   operationId="8",
 *  @OA\Parameter(
 *      name="supplierid",
 *      in="path",
 ...
 *)
 **/
class transfer_suplieridController extends Controller
{   
    public function index($supplierid)
    {   
        $curl = curl_init();
        curl_setopt_array($curl, array(
            CURLOPT_URL => "https://bookperfect.paquetedinamico.com/resources/transfer/" . $supplierid,
